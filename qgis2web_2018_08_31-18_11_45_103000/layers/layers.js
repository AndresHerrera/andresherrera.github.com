...
jsonSource_uv_viastematico_0.addFeatures(features_uv_viastematico_0);var lyr_uv_viastematico_0 = new ol.layer.Vector({
            ...
            });var format_uv_redpeatonal_1 = new ol.format.GeoJSON();
var features_uv_redpeatonal_1 = format_uv_redpeatonal_1.readFeatures(json_uv_redpeatonal_1, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_uv_redpeatonal_1 = new ol.source.Vector({
    attributions: [new ol.Attribution({html: '<a href=""></a>'})],
});
jsonSource_uv_redpeatonal_1.addFeatures(features_uv_redpeatonal_1);var lyr_uv_redpeatonal_1 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_uv_redpeatonal_1, 
                style: style_uv_redpeatonal_1,
                title: '<img src="styles/legend/uv_redpeatonal_1.png" /> uv_redpeatonal'
            });var format_uv_sitiosinteres_2 = new ol.format.GeoJSON();
var features_uv_sitiosinteres_2 = format_uv_sitiosinteres_2.readFeatures(json_uv_sitiosinteres_2, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_uv_sitiosinteres_2 = new ol.source.Vector({
    attributions: [new ol.Attribution({html: '<a href=""></a>'})],
});
jsonSource_uv_sitiosinteres_2.addFeatures(features_uv_sitiosinteres_2);var lyr_uv_sitiosinteres_2 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_uv_sitiosinteres_2, 
                style: style_uv_sitiosinteres_2,
                title: '<img src="styles/legend/uv_sitiosinteres_2.png" /> uv_sitiosinteres'
...
lyr_uv_viastematico_0.setVisible(true);lyr_uv_redpeatonal_1.setVisible(true);lyr_uv_sitiosinteres_2.setVisible(true);lyr_uv_porterias_3.setVisible(true);lyr_uv_piscina_4.setVisible(true);lyr_uv_edificaciones_5.setVisible(true);lyr_uv_cuerposagua_6.setVisible(true);lyr_uv_canchastematico_7.setVisible(true);lyr_uv_canchasdelimitacionpoly_8.setVisible(true);lyr_uv_canchasdelimitacion_9.setVisible(true);
var layersList = [baseLayer,lyr_uv_viastematico_0,lyr_uv_redpeatonal_1,lyr_uv_sitiosinteres_2,lyr_uv_porterias_3,lyr_uv_piscina_4,lyr_uv_edificaciones_5,lyr_uv_cuerposagua_6,lyr_uv_canchastematico_7,lyr_uv_canchasdelimitacionpoly_8,lyr_uv_canchasdelimitacion_9];
lyr_uv_viastematico_0.set('fieldAliases', {'__gid': '__gid', 'id': 'id', });
lyr_uv_redpeatonal_1.set('fieldAliases', {'longitud': 'longitud', });
lyr_uv_sitiosinteres_2.set('fieldAliases', {'nombre': 'nombre', 'imagen': 'imagen', });
...
lyr_uv_redpeatonal_1.set('fieldImages', {'longitud': 'TextEdit', });
lyr_uv_sitiosinteres_2.set('fieldImages', {'nombre': 'TextEdit', 'imagen': 'TextEdit', });
...
lyr_uv_redpeatonal_1.set('fieldLabels', {'longitud': 'no label', });
lyr_uv_sitiosinteres_2.set('fieldLabels', {'nombre': 'no label', 'imagen': 'no label', });
...
lyr_uv_edificaciones_5.set('fieldLabels', {'__gid': 'no label', 'id': 'inline label', 'nomencla': 'inline label', 'id_edif': 'inline label', 'etiqueta': 'inline label', 'busqueda': 'inline label', 'facultad': 'inline label', 'nume_edif': 'inline label', 'tipo': 'inline label', 'nombre': 'inline label', 'img': 'no label', });
